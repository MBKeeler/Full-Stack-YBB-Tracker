...
var findPlayer = function findPlayer(data) {
...
var app_api = __webpack_require__(6);
var app_ui = __webpack_require__(17);
...
var onModifyPlayer = function onModifyPlayer(event) {
  ...
  var data = getFormFields(this);
  event.preventDefault();
  app_api.modifyPlayer(data).then(app_ui.modifyPlayerSuccess).catch(app_ui.modifyPlayerFailure);
};
...
var onFindPlayer = function onFindPlayer(event) {
  ...
  event.preventDefault();
  //  console.log('sign-up', data)
  app_api.findPlayer(data).then(app_ui.findPlayerSuccess).catch(app_ui.findPlayerFailure);
};
...
var onGetPlayers = function onGetPlayers(event) {
  event.preventDefault();
  app_api.showAllPlayers().then(app_ui.getPlayersSuccess).catch(app_ui.showAllPlayersFailure);
};
...
var app_api = __webpack_require__(6);
var showPlayerTemplate = __webpack_require__(18);
// const store = require('../store')
...
var modifyPlayerSuccess = function modifyPlayerSuccess() {
...
var modifyPlayerFailure = function modifyPlayerFailure(error) {
...
var findPlayerSuccess = function findPlayerSuccess(data) {
  //  console.log('findPlayerSuccess called', data)
  $('show-a-player').html('data goes here: ' + data);
};

var findPlayerFailure = function findPlayerFailure(error) {
...
var getPlayersSuccess = function getPlayersSuccess(data) {
  ...
  $('#view-PlayersList').empty();
  var showPlayersHtml = showPlayerTemplate({ players: data.players });
...
module.exports = {
  ...
  modifyPlayerSuccess: modifyPlayerSuccess,
  modifyPlayerFailure: modifyPlayerFailure,
  findPlayerSuccess: findPlayerSuccess,
  findPlayerFailure: findPlayerFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <ul data-id=\""
    ...
    + "</small></li>\n    <li><small>Grade: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.grade : stack1), depth0))
    + "</small></li>\n    <li><small>Notes: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.notes : stack1), depth0))
    + "</small></li>\n    <li><small>Catch Score: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1["catch"] : stack1), depth0))
    + "</small></li>\n    <li><small>Throw Score: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1["throw"] : stack1), depth0))
    + "</small></li>\n    <li><small>Pitch Score: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.pitch : stack1), depth0))
    + "</small></li>\n    <li><small>Batting Score: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.bat : stack1), depth0))
    + "</small></li>\n    <li><small>Athleticism: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.athleticism : stack1), depth0))
    + "</small></li>\n\n    <div id=\"delete\"><button id=\"deleteBttn\" value=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" name='delete' type='click'>Delete Player</button></div>\n</ul>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    There are no players on record for this user.\n";
